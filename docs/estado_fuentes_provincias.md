...
| Araba/Álava | https://www.araba.eus/elva/Nomenclator/ELVA5003NomMuni.asp | C | hecho | |
...
| Cádiz | https://www.dipucadiz.es/diputacion/ | B | hecho | |
| Cantabria | http://administracionlocal.cantabria.es/municipios | B | pendiente | |
| Castelló/Castellón | https://datosabiertos.dipcas.es/explore/dataset/ayuntamientos/table/ | A | hecho | Dataset descargable directo |
...
| Murcia | https://www.regmurcia.com/servlet/s.Sl?METHOD=SELECCION_COMARCA&sit=c,372 | C | hecho | |
...
| Palmas, Las | https://cabildo.grancanaria.com/asociaciones-y-ayuntamientos | B | pendiente | |
...
| Salamanca | http://www.dipsanet.es/Aplicaciones/GestorInter.jsp?prestacion=Cipublico&funcion=MuestraMunicipios&codProvincia=37 | C | pendiente | |
| Santa Cruz de Tenerife | https://www.tenerife.es/municipios | B | hecho | |
...
| Zaragoza | http://www.dpz.es/municipio | A | hecho | https://zenodo.org/records/17573972/files/municipios_Aragon.csv?download=1 |
